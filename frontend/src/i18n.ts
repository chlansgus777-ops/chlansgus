...
export const STATUS_INFO: Record<string, Info> = {
  ...
  UNVERIFIED: { label: "상태 확인 불가", help: "서버에 연결되지 않아 이 추천이 지금도 유효한지 다시 판정하지 못했습니다. 새로고침한 뒤 판단하세요." },
  SUPERSEDED: { label: "새 분석 있음", help: "이 종목을 더 최근에 다시 분석했습니다. 화면의 가격 계획은 이전 분석이므로 새로고침해서 최신 분석을 보세요." },
